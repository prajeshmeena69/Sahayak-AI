...
export const BASE_STRINGS = {
  ...
  "menu.subtitle": "Choose an option to get started",
  "menu.option1.title": "Talk to AI Assistant",
  "menu.option1.desc": "Ask about government schemes by speaking",
  "menu.option2.title": "View Farmer Schemes",
  "menu.option2.desc": "Browse all available schemes for farmers",
  "menu.option3.title": "Check Crop Prices",
  "menu.option3.desc": "Get today's mandi prices for your crops",
  "menu.option4.title": "Detect Crop Disease",
  "menu.option4.desc": "Upload a photo to identify crop diseases",

  // Schemes page
  "schemes.title": "View Farmer Schemes",
  "schemes.subtitle": "Tell us about your farm and we'll find the best schemes for you",
  "schemes.locationLabel": "Where is your farm?",
  "schemes.locationPlaceholder": "Select your state",
  "schemes.needLabel": "What do you need help with?",
  "schemes.needPlaceholder": "Select your need",
  "schemes.landLabel": "How much land do you have?",
  "schemes.landPlaceholder": "Select land size",
  "schemes.need1": "Get money support 💵",
  "schemes.need2": "Crop insurance 🌱",
  "schemes.need3": "Loan or credit 🏦",
  "schemes.need4": "Farming equipment help 🚜",
  "schemes.land1": "Small (less than 2 acres)",
  "schemes.land2": "Medium (2–5 acres)",
  "schemes.land3": "Large (more than 5 acres)",
  "schemes.findBtn": "Find Schemes",
  "schemes.voiceBtn": "Or tell us by voice 🎤",
  "schemes.loading": "Finding best schemes for you…",
  "schemes.benefit": "Benefit",
  "schemes.howToApply": "How to apply",
  "schemes.noResults": "No schemes found. Please try different options.",
  "schemes.tryAgain": "Try Again",
} as const;
